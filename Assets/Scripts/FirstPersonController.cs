...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		*/
		...
		private void ABeginsTrial()							//This is where the "A" Input will fire everything off on set conditions
		{

			if (_input.jump /*&& scene_brief active OR SHOULD I PUT THIS LOGIC IN THE LOADER??*/ )
			{
